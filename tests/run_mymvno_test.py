...
import asyncio
from mvno_system.crawlers.mymvno_crawler import MyMvnoCrawler

async def main():
    print("=== Starting MyMvno Isolated Test (Session: Verify Detail & Screenshot) ===")
    
    crawler = MyMvnoCrawler()
